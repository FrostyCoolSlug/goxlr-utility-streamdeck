...
function runPlugin() {
    ...
    Utils.setFormValue(pluginSettings, document.querySelector("#toggle-mic-mute-form"))

    // Get all the default filled fields and store them to settings.
    pluginSettings = Utils.getFormValue(document.querySelector("#toggle-mic-mute-form"));
